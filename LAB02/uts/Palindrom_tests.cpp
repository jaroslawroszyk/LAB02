...
INSTANTIATE_TEST_SUITE_P(
        ...
        ::testing::Values(
                ...
                std::make_tuple("BCDCBCDABAAABEEEBABDAADDBBBBDBACBDCCABBBDDCEBEBCBAECECCBDCACEDADCCADDAECAEBDCE", true),
                std::make_tuple("BCDAECABBEABBCBBDBDDEBADAEBBBCDDBAEDEADCAAEEADCCCAAEBEBEBEBDCBEBADACBCEAEBADAAEACCEEBDBCEECEEDDEACDEDCBBAA", true),
                ...
                std::make_tuple("BDADBEEDAADCADCACDDAADDDDBACEACADEBCDCEABDADDECBDDDDCAAACEEBAEBBCECCEDCEDDDACBCEEDDDCCCADBEABEECDBEACAADCEAECCCEBDDCBECDCDCCBEBDEDDBBEDBCDEAECDCBCBCEEDDDBEDABDAEACCDBBEBADBCECCCBBCBDABEDABCABA", true),
                std::make_tuple("ACDBCDABEEEAACEDABECDDCCBDBBACABCBABDDDDDDDDBABCBACABBDBCCDDCEBADECAAEEEBADCBDCA", true)));
